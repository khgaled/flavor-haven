  ...
  return (
    <RecipeContainer>
      <RecipeWrapper>
        ...
        {/* Image */}
        <RecipeImage src={shrimp} alt="Shrimp Scampi Pasta" />
          ...
          <Grid item xs={12}>
            ...
            >
              <li>
                ...
                according to package instructions until al dente. Reserve 1/2
              ...
              <li>
                Add shrimp to the skillet. Cook for 1-2 minutes on each side
                until they turn pink and are almost cooked through.
              </li>
              <li>
              ...
              <li>
                Add butter to the skillet, creating a rich sauce. Stir until
                butter is melted and sauce is smooth.
              </li>
              <li>
                Add cooked pasta to the skillet, tossing to coat with the sauce.
                If needed, add reserved pasta water to help the sauce coat the
                pasta.
              </li>
              <li>
                Season with salt, black pepper, and red pepper flakes to taste.
              </li>
              <li>Garnish with fresh chopped parsley before serving.</li>
            </Typography>
          </Grid>
        </RecipeContent>
      </RecipeWrapper>
