...
const LeftPanel = styled(Box)({
    width: '33.33%',
    backgroundColor: "#82A5D9", // Using a Japanese-inspired blue color
                ...
                <ContentCard>
                    ...
                    <CaptionBox>
                        ...
                        <Typography variant="body1" sx={{ textAlign: 'left' }}>
                            Discover the art of authentic Japanese cuisine at Sakura Sushi. Our master chefs craft each dish with precision and care, using only the freshest ingredients. From traditional sushi to innovative fusion dishes, we invite you to experience the true essence of Japan. #SushiLover #JapaneseCuisine #FreshSeafood
                        </Typography>
                    </CaptionBox>
                </ContentCard>
            </RightPanel>
